...
Figma でのデザイン設計から Next.js 実装、Vercel への本番デプロイ、Contentful による CMS 連携、Resend を用いた問い合わせ実装までを独力で完結できることが強みです。デザインとエンジニアリングを横断して捉えられることが、UI / UX の品質向上に直結すると考えています。
